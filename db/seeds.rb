...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  Customer.create(name: 'Allianz', description: 'Allianz SE merkezi Almanyanın Münih kentinde bulunan dünyanın en büyük sigorta ve finansal yatırım şirketlerinden birisidir.')
